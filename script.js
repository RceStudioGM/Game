...
const storyData = {
    ...
    prolog_2: {
        speaker: "Pak Hendra",
        text: `${playerName} Bapak lihat nilai ulanganmu turun. Daripada bengong di kelas kosong, mending kamu ikut bantu persiapan Festival Sekolah.`,
    ...
    bima_sindir: {
        speaker: "Bima",
        text: `Woy! Denger-denger kamu ditarik OSIS sama anak seni sekaligus? Kamu ini pemeran utama drama apaan sih, ${playerName}.`,
